...
- [ ] Страница `/dashboard` отображает список заметок (не только хедер)
...
Если хочешь, могу помочь сделать этот чеклист в Notion с чекбоксами и разделами — просто скажи!
